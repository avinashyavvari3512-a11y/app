  ...
  const experiences = [
    {
      ...
      color: '#4F8CFF',
      achievements: [
        'Built Healthcare AI Lakehouse processing 15M+ records monthly using Azure Databricks, Synapse, and Delta Lake',
        'Developed Revenue Cycle Intelligence Platform with 92% prediction accuracy for claim denials',
        'Architected real-time data pipelines reducing processing time by 65% using ADF and Spark',
        'Delivered 50+ Power BI dashboards driving $10M+ in revenue optimization',
      ],
